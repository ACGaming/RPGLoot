...
@EventBusSubscriber(value = {Side.CLIENT}, modid = "rpgloot")
public class ClientEvents
{
    ...
    public static void drawLootIcon(RenderGameOverlayEvent event)
    {
        ...
        if (target != null && target.entityHit instanceof EntityCorpse)
        {
            ...
            tm.bindTexture(new ResourceLocation("rpgloot", "textures/loot.png"));
    ...
    public static void onGuiScreen(GuiOpenEvent event)
    {
        if (event.getGui() instanceof GuiConfig)
        {
            ...
            if (guiConfig.modID.equals("rpgloot") && guiConfig.titleLine2 != null && guiConfig.titleLine2.equals("mobs list"))
